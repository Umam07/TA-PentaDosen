...
import { ChevronRight, ArrowLeft, FileText, CheckCircle2, Download, Eye, Upload, Building2, Briefcase, GraduationCap, User, Info, Layers, BookOpen, Globe } from 'lucide-react';
...
export const DetailPublikasiModal: React.FC<PublicationDetailViewProps> = ({ detail, onBack, onPreview, onDownload, onUpload }) => {
  return (
